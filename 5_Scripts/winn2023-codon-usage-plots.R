...
C_ambionensis <- read_excel("./Codon Usage/Codon Usage.xlsx", sheet = "Carcharhinus ambionensis")
G_galeus <- read_excel("./Codon Usage/Codon Usage.xlsx", sheet = "Galeorhinus galeus")
G_melastomus <- read_excel("./Codon Usage/Codon Usage.xlsx", sheet = "Galeus melastomus")
H_japanica <- read_excel("./Codon Usage/Codon Usage.xlsx", sheet = "Hemitriakis japanica")
M_asterias <- read_excel("./Codon Usage/Codon Usage.xlsx", sheet = "Mustelus asterias")
M_griseus <- read_excel("./Codon Usage/Codon Usage.xlsx", sheet = "Mustelus griseus")
M_manazo <- read_excel("./Codon Usage/Codon Usage.xlsx", sheet = "Mustelus manazo")
M_mosis <- read_excel("./Codon Usage/Codon Usage.xlsx", sheet = "Mustelus mosis")
M_mustelus <- read_excel("./Codon Usage/Codon Usage.xlsx", sheet = "Mustelus mustelus")
M_palumbes <- read_excel("./Codon Usage/Codon Usage.xlsx", sheet = "Mustelus palumbes")
T_megalopterus <- read_excel("./Codon Usage/Codon Usage.xlsx", sheet = "Triakis megalopterus")
