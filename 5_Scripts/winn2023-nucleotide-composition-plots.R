...
## Path to output PDFs
pdfPath <- './Nucleotide Composition Plot/'

## Import the data

library(readxl)

C_amboinensis <- read_excel("./Nucleotide Composition Plot/Nucleotide Composition.xlsx", sheet = "Carcharhinus amboinensis")
G_galeus <- read_excel("./Nucleotide Composition Plot/Nucleotide Composition.xlsx", sheet = "Galeorhinus galeus")
G_melastomus <- read_excel("./Nucleotide Composition Plot/Nucleotide Composition.xlsx", sheet = "Galeus melastomus")
H_japanica <- read_excel("./Nucleotide Composition Plot/Nucleotide Composition.xlsx", sheet = "Hemitriakis japanica")
M_asterias <- read_excel("./Nucleotide Composition Plot/Nucleotide Composition.xlsx", sheet = "Mustelus asterias")
M_griseus <- read_excel("./Nucleotide Composition Plot/Nucleotide Composition.xlsx", sheet = "Mustelus griseus")
M_manazo <- read_excel("./Nucleotide Composition Plot/Nucleotide Composition.xlsx", sheet = "Mustelus manazo")
M_mosis <- read_excel("./Nucleotide Composition Plot/Nucleotide Composition.xlsx", sheet = "Mustelus mosis")
M_mustelus <- read_excel("./Nucleotide Composition Plot/Nucleotide Composition.xlsx", sheet = "Mustelus mustelus")
M_palumbes <- read_excel("./Nucleotide Composition Plot/Nucleotide Composition.xlsx", sheet = "Mustelus palumbes")
T_megalopterus <- read_excel("./Nucleotide Composition Plot/Nucleotide Composition.xlsx", sheet = "Triakis megalopterus")
