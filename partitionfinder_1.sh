...
#PBS -m abe
#PBS -e partitions_1.err
#PBS -o partitions_1.out
...
iqtree -s /home/21634076/Carcharhiniform_mitogenomics/ML/Galeomorphi_cleaned_alignment.phy -spp /home/21634076/Carcharhiniform_mitogenomics/ML/partitions_1/partitions_1.nex -m MF+MERGE -rcluster 30 -AICc
